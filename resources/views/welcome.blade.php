        ...
        <div class="w-3/6 h-96 pl-8 border-l-2">
            <form class="flex-auto p-2 mr-6">
                ...
                <div class="flex flex-wrap">
                    <h1 class="flex-auto text-3xl font-semibold">
                        NIKE FAKE
                    </h1>
                    <div class="text-3xl font-semibold text-gray-500 mr-2">
                        $90.00
                    </div>
                    <div class="text-xl font-semibold text-gray-500 pl-2 line-through mr-9">
                        $110.00
                    </div>
